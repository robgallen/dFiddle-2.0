...
define(['durandal/system', 'durandal/app', 'durandal/activator', 'durandal/events', 'durandal/composition', 'plugins/history', 'knockout', 'jquery'], function(system, app, activator, events, composition, history, ko, $) {
    ...
    var createRouter = function() {
        ...
        /**
		 * Amend the hash fragment for a route
		 * @method updateHashFragment
		 * @param {string} fragment The hash fragment to use.
		 */
		router.updateHashFragment = function (fragment) {
        ...
        router.loadUrl = function(fragment) {
            var handlers = router.handlers,
                queryString = null,
                coreFragment = fragment.slice(hashFragment.length - 1),
